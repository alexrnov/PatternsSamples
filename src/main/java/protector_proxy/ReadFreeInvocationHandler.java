...
/**
 * Обработчик для пользователя, у которого есть права только на чтение
 * открытых данных. Все обработчики реализуют интерфейс InvocationHandler
 */
public class ReadFreeInvocationHandler implements InvocationHandler {
   ...
   */
  public ReadFreeInvocationHandler(Information information) {
